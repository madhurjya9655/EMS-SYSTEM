...
def preserve_first_occurrence_time(planned_dt: datetime | None) -> datetime | None:
    ...
    - Keep exact date+time the user chose.
    ...
    # Make aware in IST if naive, then convert to project TZ
...
def get_next_planned_date(prev_dt: datetime, mode: str, frequency: int) -> datetime | None:
    ...
    Examples:
      ...
      - Monthly + 4: every 4 months on the same day-of-month, 10:00 IST (calendar-safe)
