...
urlpatterns = [
    ...
    path("fms/delete/<int:pk>/", views.delete_fms, name="delete_fms"),
    ...
    path(
        "bulkupload/checklist-template/",
        views.download_checklist_template,
        name="download_checklist_template",
    ),
    path(
        "bulkupload/delegation-template/",
        views.download_delegation_template,
        name="download_delegation_template",
    ),
    ...
    path(
        "internal/cron/pending-7pm/",
        cron_views.pending_summary_7pm,
        name="cron_pending_7pm",
    ),
    path(
        "internal/cron/employee-digest/",
        cron_views.employee_digest,
        name="cron_employee_digest",
    ),
    path(
        "internal/cron/pre10am-unblock/<str:token>/",
        pre10am_unblock_and_generate_hook,
        name="cron_pre10_with_token",
    ),
    path(
        "internal/cron/pre10am-unblock/",
        pre10am_unblock_and_generate_hook,
        name="cron_pre10",
    ),
]