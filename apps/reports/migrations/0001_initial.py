# Generated by Django 5.2.1 on 2025-06-11 09:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='weekly_commitments', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-week_start'],
